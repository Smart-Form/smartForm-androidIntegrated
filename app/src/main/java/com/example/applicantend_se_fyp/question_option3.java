...
public class question_option3 extends AppCompatActivity {
    int nextPageID = 6; // Default
    Class nextPageName;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_question_option3);
        ...
        btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                startActivity(new Intent(question_option3.this, nextPageName));
            }
        });
                ...
                public void onClick(View v) {
                    if (thisObj.getTag() == null) {
                        ...
                        for (int i=0; i<total_resource; i++) {
                            ...
                            obj.setBackgroundTintList(ContextCompat.getColorStateList(question_option3.this, R.color.disableColor));
                            obj.setTextColor(ContextCompat.getColorStateList(question_option3.this, R.color.secondaryTextColor));
                            obj.setTag(0);
                        }

                        // Color the clicked option
                        thisObj.setBackgroundTintList(ContextCompat.getColorStateList(question_option3.this, R.color.secondaryColor));
                        thisObj.setTextColor(ContextCompat.getColorStateList(question_option3.this, R.color.primaryTextColor));
                        thisObj.setTag(1);
    ...
    CountDownTimer countDownTimer = new CountDownTimer(600000, 1000) {
        ...
        public void onFinish() {
            ...
            startActivity(new Intent(question_option3.this, language.class));
        }
    }.start();
    @Override
